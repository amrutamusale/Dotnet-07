...
export class TweetComponent implements OnInit {
  ...
  AddTweet() {
    ...
    this.httpc.post("https://localhost:44308/api/Upload",formData).subscribe(res=>{console.log(res); this.img=res;admindto.tweetImage=this.img.imageUrl;this.AddTweetData(admindto);},res=>console.log(res));
  ...
  getData(email: any) {
    console.log("Hi");
    this.httpc.get("https://localhost:44308/api/Tweet/GetTweetsByUserName?username=" + email).subscribe(res => this.GetSuccess(res), res => this.GetError(res));
  }
